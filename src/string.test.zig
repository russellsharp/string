...
const mod_string = @import("string.zig");
const string = mod_string.string;
const empty_buffer = mod_string.empty_buffer;
const StringErrors = mod_string.StringErrors;
...
test "shrink_to_fit" {
    ...
    _ = str_0.assign(test_base_shorter);
